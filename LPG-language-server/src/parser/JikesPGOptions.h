...
public:
    typedef bool JiksPgOption::*BooleanValueField;
    typedef int JiksPgOption::*IntegerValueField;
    typedef const char *JiksPgOption::*StringValueField;
    typedef char JiksPgOption::*CharValueField;
    ...
    JiksPgOption *getOptions() const { return options; }

private:
    JiksPgOption *options;
};
